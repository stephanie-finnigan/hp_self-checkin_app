...
namespace SelfCheckinWebApp.ViewModels
{
    public class BookingViewModel
    {
        ...
        [DataType(DataType.MultilineText)]
        [Display(Name = "Housekeeping Notes")]
        public string HousekeepingNotes { get; set; }

        [DataType(DataType.MultilineText)]
        [Display(Name = "Restaurant Notes")]
        ...
        public bool PackageBreakfastInclusive { get; set; }

        public bool PackageLunchInclusive { get; set; }

        public bool PackageDinnerInclusive { get; set; }
